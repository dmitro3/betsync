...
cogs = [
    ...
    "Cogs.games.match", "Cogs.sol_deposit", "Cogs.games.slots", "Cogs.games.build" , "Cogs.referrals", "Cogs.channel_management" , "Cogs.daily", "Cogs.private_threads" , "Cogs.admin_curse"
]
